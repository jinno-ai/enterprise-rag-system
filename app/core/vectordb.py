...
class FAISSVectorDB(VectorDB):
    ...
    def search(
        ...
        # If we have filters, we might need to retrieve more candidates and then filter in memory
        # because FAISS doesn't support metadata filtering natively in IndexFlat
