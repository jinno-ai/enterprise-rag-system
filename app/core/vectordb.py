...
class VectorDB(ABC):
    ...
    def add_documents(
        ...
        """
        High-level method to add documents to the database.
        Ensures document text is in metadata before calling upsert.
        """
        import uuid
        ...
        # Initialize index if not created (for FAISS)
...
class FAISSVectorDB(VectorDB):
    ...
    def search(
        ...
        # If filtering is needed, we need to retrieve more results and then filter
