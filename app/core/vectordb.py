...
class VectorDB(ABC):
    ...
    def add_documents(
        ...
        if metadatas is None:
            ...
            # Shallow copy to avoid modifying the original list items
...
class FAISSVectorDB(VectorDB):
    ...
    def search(
        ...
        # FAISS doesn't support metadata filtering natively in IndexFlatIP.
        # We perform a larger search and filter manually.
