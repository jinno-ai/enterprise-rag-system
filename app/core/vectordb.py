...
class VectorDB(ABC):
    ...
    def add_documents(
        ...
        This is a convenience method that generates IDs and includes text in metadata.
        """
        if not documents:
            return []
        ...
        # Ensure index exists if it's handled via an 'index' attribute (like FAISS/Pinecone)
...
class FAISSVectorDB(VectorDB):
    ...
    def search(
        ...
        # If filtering is requested, we over-sample to increase chances of finding enough matches
        ...
        for dist, idx in zip(distances[0], indices[0]):
            ...
            if id_:
                ...
                # Apply filters locally for FAISS
                if filter_dict:
                    match = True
                ...
                # Stop if we found enough results after filtering
