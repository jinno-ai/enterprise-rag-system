...
class ValidationMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        try:
            ...
            # Catch HTTPExceptions and return as JSONResponse
            # This prevents BaseHTTPMiddleware from swallowing them and returning 500
            return JSONResponse(
            ...
            logger.error(f"Unhandled error in validation middleware: {exc}", exc_info=True)
            return JSONResponse(
                status_code=500,
    ...
    async def _validate_string_value(self, value: str, request: Request, path: str):
        ...
        Raises:
            HTTPException: 400 if malicious content detected
        """
        # Get client IP for logging safely
